...
var _showVideo = require("./modules/gym/showVideo");
var _initTabs = require("./modules/tabs/init-tabs");
var _initAccordion = require("./modules/accordion/init-accordion");
var _selectMembership = require("./modules/memberships/selectMembership");
var _showCoachInfo = require("./modules/coaches/showCoachInfo");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  (0, _showVideo.showVideo)();
  (0, _selectMembership.selectMembership)();
  (0, _showCoachInfo.showCoachInfo)();
...
},{"./modules/accordion/init-accordion":3,"./modules/coaches/showCoachInfo":4,"./modules/form-validate/form":6,"./modules/gym/showVideo":12,"./modules/memberships/selectMembership":13,"./modules/modals/init-modals":14,"./modules/tabs/init-tabs":16,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
exports.showCoachInfo = showCoachInfo;
function showCoachInfo() {
  var coachesElements = document.querySelectorAll('.coach');
  coachesElements.forEach(function (item) {
    return item.addEventListener('click', function () {
      coachesElements.forEach(function (element) {
...
function showVideo() {
  ...
  var playIcon = video.querySelector('.video__play');
  video.addEventListener('click', function () {
    video.insertAdjacentHTML('afterbegin', '<iframe src="https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>');
...
exports.selectMembership = selectMembership;
function selectMembership() {
  var membershipsElements = document.querySelectorAll('.membership');
  membershipsElements.forEach(function (item) {
    return item.addEventListener('click', function () {
      membershipsElements.forEach(function (element) {
        return element.classList.remove('is-active');
      });
      item.classList.add('is-active');
    });
